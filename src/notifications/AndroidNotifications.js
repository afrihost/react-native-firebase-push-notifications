...
export default class AndroidNotifications {
  ...
  createChannel(channel: AndroidChannel): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.createChannel(channel.build())
    }
  ...
  createChannelGroup(channelGroup: AndroidChannelGroup): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.createChannelGroup(channelGroup.build())
    }
    return Promise.resolve()
  }
  ...
  createChannelGroups(channelGroups: AndroidChannelGroup[]): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.createChannelGroups(nativeChannelGroups)
    }
    return Promise.resolve()
  }
  ...
  createChannels(channels: AndroidChannel[]): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.createChannels(nativeChannels)
    }
    return Promise.resolve()
  }
  ...
  removeDeliveredNotificationsByTag(tag: string): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.removeDeliveredNotificationsByTag(tag)
    }
    return Promise.resolve()
  }
  ...
  deleteChannelGroup(groupId: string): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.deleteChannelGroup(groupId)
    }
    return Promise.resolve()
  }
  ...
  deleteChannel(channelId: string): Promise<void> {
    if (Platform.OS === "android") {
      ...
      return FirebaseNotifications.deleteChannel(channelId)
    }
    return Promise.resolve()
  }
  ...
  getChannel(channelId: string): Promise<?NativeAndroidChannel> {
    if (Platform.OS === "android") {
      ...
      return Promise.resolve(FirebaseNotifications.getChannel(channelId))
    }
  ...
  getChannels(): Promise<NativeAndroidChannel[]> {
    if (Platform.OS === "android") {
      return Promise.resolve(FirebaseNotifications.getChannels())
    }
    return Promise.resolve([])
  }
  ...
  getChannelGroup(channelGroupId: string): Promise<?NativeAndroidChannelGroup> {
    if (Platform.OS === "android") {
      ...
      return Promise.resolve(
        FirebaseNotifications.getChannelGroup(channelGroupId)
      )
    }
    return Promise.resolve(null)
  }
  ...
  getChannelGroups(): Promise<NativeAndroidChannelGroup[]> {
    if (Platform.OS === "android") {
      return Promise.resolve(FirebaseNotifications.getChannelGroups())
    }
    return Promise.resolve([])
  }
}
