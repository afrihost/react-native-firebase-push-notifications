...
@interface FirebasePushNotifications () <UNUserNotificationCenterDelegate>
#else
@interface FirebasePushNotifications ()
#endif
@end

@implementation FirebasePushNotifications {
...
static FirebasePushNotifications *theFirebasePushNotifications = nil;
...
+ (void)configure {
    ...
    theFirebasePushNotifications = [[FirebasePushNotifications alloc] init];
}

RCT_EXPORT_MODULE(FirebaseNotifications);

- (id)init {
    self = [super init];
    if (self != nil) {
        DLog(@"Setting up FirebasePushNotifications instance");
        [self initialise];
    }
    return self;
}
...
- (void)initialise {
    ...
    theFirebasePushNotifications = self;
